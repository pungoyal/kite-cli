...
[GitHub Security Advisory](https://github.com/pungoyal/kite-cli/security/advisories/new)
(the same private channel [SECURITY.md](SECURITY.md) uses), or by contacting
the maintainer, [@pungoyal](https://github.com/pungoyal), directly. All
